...
riders_list = [
    {
        ...
        "dropoff_address": "44 W 4th St, New York, NY 10012, USA"
    },
    {
        "rider_id": 2,
        "pickup_time": 6,
        ...
        "dropoff_address": "33 Washington Square W, New York, NY 10011, USA\r"
    },
    {
        "rider_id": 3,
        "pickup_time": 8,
        ...
        "dropoff_address": "129 Washington streey e New York NY 10011 USA"
    },
    {
        "rider_id": 4,
        "pickup_time": 13,
        ...
        "dropoff_address": "124 Broadway  New York NY 10025 USA"
    },
    {
        "rider_id": 5,
        "pickup_time": 9,
        ...
        "dropoff_address": "502 Delency Street New York NY 1025"
    },
    {
        "rider_id": 6,
        "pickup_time": 21,
        ...
        "dropoff_address": "536 Clinton Street New York NY 1100"
    },
    {
        "rider_id": 7,
        "pickup_time": 5,
        ...
        "dropoff_address": "105 Housetone Street New York NY 1200"
    },
    {
        "rider_id": 8,
        "pickup_time": 12,
        ...
        "dropoff_address": "201 lexinton Avinue New York NY 20000"
    },
    {
        "rider_id": 9,
        "pickup_time": 10,
        ...
        "dropoff_address": "102 Time Square New York NY 2001"
    },
    {
        "rider_id": 10,
        "pickup_time": 13,
        ...
        "dropoff_address": "524 Ozone Park New York NY 20000."
    }
]
...
class Rider:
    def __init__(self, rider_id, pickup_time, pickup_address, pickup_location, dropOff_address):
...
# Creating dynamic variables for Rider class
passengers = {}  # Container for dummy riders
for count, value in enumerate(riders_list):
    key = str("rider" + str(count + 1))
    passengers[key] = value

# Executing key as variable name and value as value e.g. rider1 = {...}
for key, value in passengers.items():
    exec(f"{key} = {value}")
    exec(f"{key} = Rider(rider_id={key}['rider_id'], pickup_time={key}['pickup_time'], pickup_address={key}['pickup_address'], pickup_location={key}['pickup_location'], dropOff_address={key}['dropoff_address'])")

if __name__ == "__main__":
    # Creating objects of Rider from passengers list
    # print(rider1)

    print(rider5.pickup_time)
